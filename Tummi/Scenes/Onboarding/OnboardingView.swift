            ...
            VStack(alignment: .leading, spacing: 22) {
                ...
                VStack(alignment: .leading, spacing: 10) {
                    ...
                    if isPreterm {
                        ...
                        Text("Spoonlet will use corrected age for feeding milestones and growth charts, which is how they are meant to be read for preterm babies.")
                            .font(.system(size: 13))
                            .foregroundStyle(Theme.faint)
                    }
                }
                ...
                HStack(alignment: .top, spacing: 11) {
                    ...
                    VStack(alignment: .leading, spacing: 3) {
                        Text("The green chips are links")
                            ...
                            .foregroundStyle(Theme.ink)
                        Text("Under every recommendation you will see something like “WHO, 2023”. Tap it and the actual guideline opens. Nothing in Spoonlet asks you to take its word for it.")
                            .font(.system(size: 13))
                            .foregroundStyle(Theme.secondary)
        ...
        ScrollView {
            VStack(alignment: .leading, spacing: 18) {
                ...
                VStack(alignment: .leading, spacing: 14) {
                    disclaimerRow(
                        "stethoscope",
                        String(localized: "Spoonlet is not a doctor"),
                    ...
                    disclaimerRow(
                        ...
                        String(localized: "Everything is stored on this device. Spoonlet has no account, no server and no analytics.")
                    )
                }
