    ...
    var body: some View {
        ...
        .sheet(isPresented: $showsOverride) {
            OverrideSheet(
                ...
                explanation: String(localized: "If your paediatrician gave you a different age, put it here. Spoonlet will use your date and still show you what the published guidance says."),
