...
struct SettingsView: View {
    ...
    private var remindersCard: some View {
        VStack(alignment: .leading, spacing: 12) {
            ...
            Text("Three reminders, and nothing else. Spoonlet will never nag you about feeds — you already know when your baby is hungry.")
                .font(.system(size: 13))
            ...
            if permissionDenied {
                Text("Notifications are turned off for Spoonlet in iOS Settings, so these will not appear.")
    ...
    private var dataCard: some View {
        VStack(alignment: .leading, spacing: 12) {
            ...
            Text("Spoonlet has no account and no server. Everything lives in this app's storage on this device, and nothing is sent anywhere unless you export it yourself.")
                .font(.system(size: 13))
                .foregroundStyle(Theme.secondary)
    ...
    private var disclaimerCard: some View {
        VStack(alignment: .leading, spacing: 8) {
            ...
            Text("Spoonlet summarises published infant feeding guidance. It is not a medical device, it does not diagnose, and it cannot examine your baby. Always check with your paediatrician before making decisions about feeding, supplements or allergen introduction — and seek urgent care for breathing difficulty, facial swelling, repeated vomiting after a food, or a baby who stops feeding.")
                .font(.system(size: 13))
                .foregroundStyle(Theme.secondary)
